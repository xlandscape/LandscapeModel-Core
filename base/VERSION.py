...
VERSION: base.VersionCollection = base.VersionCollection(
    base.VersionInfo("1.18.2", "2026-04-18"),
    base.VersionInfo("1.18.1", "2025-12-11"),
    ...
    base.VersionInfo("1.12.5", "2022-01-12"),
    ...
    base.VersionInfo("1.10.5", "2021-12-09"),
    base.VersionInfo("1.10.4", "2021-12-08"),
    ...
    base.VersionInfo("1.9.12", "2021-11-16"),
    base.VersionInfo("1.9.11", "2021-11-08"),
    ...
    base.VersionInfo("1.9.6", "2021-10-22"),
    base.VersionInfo("1.9.5", "2021-10-21"),
...
VERSION.changed("1.18.1", "Relaxed limitations in scenario schema for version numbers and file names")
